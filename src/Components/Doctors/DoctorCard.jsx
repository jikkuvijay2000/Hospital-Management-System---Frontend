    ...
    <div className="p-3 lg:p-5">
      ...
      <div className="mt-2 lg:mt-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-[6px] ">
          <span className="flex items-center gap-[6px] text-[14px] leading-6 lg:text-[16px] leading-7 font-semibold text-headingColor">
            <img src={starIcon}></img> {averageRating}
          </span>
      ...
      <div className="mt-[18px] lg:mt-5 flex items-center justify-between">
        ...
        <Link
          ...
          className="w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E]  flex items-center items-center justify-center group hover:bg-primaryColor hover:border-none"
        >
