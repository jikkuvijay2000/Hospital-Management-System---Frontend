    ...
    <section className='hero_section pt-[60px] 2xl:h-[800px]'>
      <div className='container'>
       ...
       <div className='lg:w-[570px]'>
        ...
        At Medicare, we are dedicated to providing exceptional healthcare services tailored to your individual needs.
        We strive to ensure your experience with us is comfortable and effective. Book an appointment today and experience the difference in patient-centered care at Medicare
        </p>
    ...
    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'>
        ...
        <div className='py-[30px] px-5'>
          ...
          <h2 className='text-[26px] leading-9 text-headingColor font-[700] text-center'>Find a doctor</h2>
            ...
            <Link to='/doctors' className='w-[44px] h-[44px] rounded-full border border-solid border-[#181A1E] mt-[30px] mx-auto flex items-center items-center justify-center group hover:bg-primaryColor hover:border-none'>
   ...
   <section>
      <div className='container'>
        <div className='xl:w-[470px] mx-auto'>
          ...
          <p className='text_para text-center mt-5'>World-class care for everyone. Our health system offers unmatched,expert health care</p>
        </div>
      </div>
              ...
              <div className='relative z-10 xl:w-[770px] flex justify-end mt-[50px] lg:mt-0'>
                ...
                <div className='w=[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-20 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb=[26px] rounded-[10px]'>
                      ...
                      <div className='flex items-center gap-[6px] lg:gap-[10px] mt-2 lg:mt-[18px]'>
                          ...
                          <h4 className='text-[10px] leading-3 lg:text-[16px] lg:leading-[22px] font-[700 text-headingColor]'>Jikku Vijay</h4>
                      </div>
                </div>
              </div>
   ...
   <div className='container mt-[70px]'>
    ...
    <div className='container'>
      <div className='flex justify-between gap-[50px] lg:gap-0'>
        <div className='w-1/4 md:block'> <img src={faqImg}></img> </div>
        
      <div className='w-full md:w-1/2'>
        <h2 className='heading'>Frequently asked questions  by our patients</h2>
        <Faqlist/>
      </div>
